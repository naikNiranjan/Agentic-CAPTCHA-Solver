...
const defaultFavoritePrompts = [
  {
    title: '🔓 Test CAPTCHA Solving',
    content:
      '- Navigate to a website with CAPTCHAs\n- Identify the CAPTCHA type (text, image, audio)\n- Attempt to solve the CAPTCHA automatically\n- Report success/failure and any issues encountered',
  },
  {
    title: '🤖 CAPTCHA Analysis',
    content: 'Analyze different CAPTCHA types on various websites and document their complexity and solving strategies.',
  },
  {
    title: '⚙️ Configure Settings',
    content: 'Set up your AI model preferences and API keys for optimal CAPTCHA solving performance.',
  },
];
